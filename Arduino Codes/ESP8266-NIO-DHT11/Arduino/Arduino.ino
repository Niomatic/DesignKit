/*****************************************************************************************
   Name          : Run DHT11 temperature & humidity sensor using Niomatic App
   ...
   Version       : 1.6
   Description   : Runnig DHT11 sensor and sending datas with Json over TCP/UDP
...
******************************************************************************************
  ESP8266 Arduino platform stable release  https://github.com/esp8266/Arduino
   ...
   DHT temperature/humidity sensors         https://github.com/adafruit/DHT-sensor-library
...
******************************************************************************************
  ...
  (DHT11 - DHT22 - DHT21 - AM2301) temperature/humidity sensors Modules
...
******************************************************************************************
  Wiring :
  (DHT sensor module)DOUT pin --> ESP8266 GPIO2 (D4 on Nodemcu board)
*/
