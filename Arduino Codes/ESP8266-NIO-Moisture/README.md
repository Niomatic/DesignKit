# ESP8266 Niomatic Moisture sensors
Runnig Moisture sensor with ESP8266 board, sending signals to Niomatic android application trough Json over TCP/UDP
...
### OTA Config (over the air programming)
...
### Schematic
![alt text](https://github.com/Niomatic/DesignKit/blob/design-stage/Arduino%20Codes/ESP8266-NIO-Moisture/Schemtaic/Schematic.png?raw=true)
