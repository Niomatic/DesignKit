/*****************************************************************************************
   Name          : Run Sound sensor using Niomatic App
   ...
   Version       : 1.6
   Description   : Runnig Sound sensor and sending datas with Json over TCP/UDP
...
******************************************************************************************
  Wiring :
  (Sound module)AOUT pin --> ESP8266 A0
*/
