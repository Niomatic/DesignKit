# ESP8266 Niomatic Control Dc motor with L298 module
 Control Dc motor with L298 module with ESP8266 board and Niomatic android application trough Json over TCP/UDP
