/*****************************************************************************************
   Name          : Run GL-xxx photocell sensor(in lux and footcandles) using Niomatic App
   ...
   Version       : 1.6
   Description   : Runnig GL-xxx photocell sensor (in lux and footcandles) and sending datas with Json over TCP/UDP
...
******************************************************************************************
  ...
  photocell                                https://github.com/QuentinCG/Arduino-Light-Dependent-Resistor-Library
...
******************************************************************************************
   ...
   GL-xxx series photocell sensors Modules
...
LightDependentResistor photocell(USED_PIN, OTHER_RESISTOR, USED_PHOTOCELL); // Create a GL5528 photocell instance (on A0 pin)
