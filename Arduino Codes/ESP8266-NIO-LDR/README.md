# ESP8266 Niomatic GL-xxx photocell sensor(in lux and footcandles)
Runnig GL-xxx photocell sensor(in lux and footcandles) with ESP8266 board, sending signals to Niomatic android application trough Json over TCP/UDP
...
| photocell library | https://github.com/QuentinCG/Arduino-Light-Dependent-Resistor-Library |
...
### Schematic
![alt text](https://github.com/Niomatic/DesignKit/blob/design-stage/Arduino%20Codes/ESP8266-NIO-LDR/Schemtaic/Schematic.png?raw=true)
